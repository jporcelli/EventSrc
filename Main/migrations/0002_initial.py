...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventPhoto.type'
        db.add_column(u'Main_eventphoto', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.latlng'
        db.add_column(u'Main_event', 'latlng',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(default=None),
                      keep_default=False)

        # Adding field 'Event.created_on'
        db.add_column(u'Main_event', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.updated_on'
        db.add_column(u'Main_event', 'updated_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventPhoto.type'
        db.delete_column(u'Main_eventphoto', 'type')

        # Deleting field 'Event.latlng'
        db.delete_column(u'Main_event', 'latlng')

        # Deleting field 'Event.created_on'
        db.delete_column(u'Main_event', 'created_on')

        # Deleting field 'Event.updated_on'
        db.delete_column(u'Main_event', 'updated_on')
    ...
    models = {
        ...
        u'Main.eventphoto': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'})
        },
        u'auth.group': {
